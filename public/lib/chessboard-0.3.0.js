...
function drawPositionInstant() {
  ...
  for (var i in SQUARE_ELS_IDS) {
    if (CURRENT_POSITION[i] && (CURRENT_ORIENTATION[0] === CURRENT_POSITION[i][0])) {
      ...
      if (generateNeighbors(i, 1).filter(pos => CURRENT_POSITION[pos] && (CURRENT_ORIENTATION[0] === CURRENT_POSITION[pos][0])).length > 0) {
      ...
      document.getElementById(SQUARE_ELS_IDS[i]).classList.remove('fog');
        ...
        document.getElementById(SQUARE_ELS_IDS[i]).classList.add('fog');
        document.getElementById(SQUARE_ELS_IDS[i]).classList.remove('dark');
      } else {
        document.getElementById(SQUARE_ELS_IDS[i]).classList.add('dark');
        document.getElementById(SQUARE_ELS_IDS[i]).classList.remove('fog');
      }
